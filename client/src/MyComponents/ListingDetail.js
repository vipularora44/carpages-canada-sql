...
export default function ListingDetail() {
    ...
    console.log(Listing_ID+"Data.."+seller_id);
     ...
     useEffect(()=>{
            ...
            Axios.post("http://localhost:3001/listings/getListingDetail",{ListingId:Listing_ID}).then((res)=>{
              console.log(res.data);
              setvehicledata(res.data);
              setMyvehiclePrice(res.data[0].price);
            });
            Axios.post("http://localhost:3001/listings/getListingImages",{ListingId:Listing_ID}).then((res1)=>{
           ...
           Axios.post("http://localhost:3001/listings/getmoreListings",{userId:Seller_ID,ListingId:Listing_ID}).then((res2)=>{
    ...
    Axios.get("http://localhost:3001/users/isUserAuthenticated",{headers:{"x-access-token":Item["token"]},}).then((res)=>{
       ...
       console.log(res.data.auth);
        if(res.data.auth)
        {
          ...
          Axios.post("http://localhost:3001/watchlist/insertWatchList",{userId:Item["userId"],listing_id:Listing_ID}).then((res)=>{
            console.log(res.data);
  ...
  const sendMessage=()=>
   {
    ...
    Axios.post("http://localhost:3001/users/sendQueryMessagePhone",{queryName:queryName,queryPhone_No:queryPhone_No,queryEmail:queryEmail,queryYear:queryYear,queryMake:queryMake,queryModel:queryModel}).then((res)=>{
      console.log(res.data);
     });
   }
