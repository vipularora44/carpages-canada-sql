...
export default function SearchResults() {
  ...
  Axios.get("http://localhost:3001/users/isUserAuthenticated",{headers:{"x-access-token":Item["token"]},}).then((res)=>{
    ...
    {Axios.get("http://localhost:3001/listings/get_allListings").then((res)=>{
     ...
     Axios.get("http://localhost:3001/listings/get_allListings_images").then((res)=>{
     // console.log(res.data);
     ...
     else if(MyState)
     {
          ...
          {
            Axios.post("http://localhost:3001/listings/search_bar",{keyword:MyState.keyWord}).then((res)=>{
              console.log(res.data);
              setfetchListings(res.data);
              });
          }
            ...
            Axios.get("http://localhost:3001/categories/viewcategory").then((res1)=>{
           //   console.log(res1.data);
              setvehiclecategory(res1.data);
            });

            Axios.get("http://localhost:3001/categories/getprices").then((res2)=>{
            //  console.log(res2.data);
              setvehicleprice(res2.data);
            });
            Axios.get("http://localhost:3001/categories/years").then((res3)=>{
         //     console.log(res3.data);
              setvehicleyears(res3.data);
            });
            Axios.get("http://localhost:3001/categories/onlycities").then((res1)=>{
            //  console.log(res1.data);
  ...
  useEffect(()=>{
    ...
    { 
      if(type=="private")
      {
        Axios.post("http://localhost:3001/listings/FilterByListingSellertype",{ListingSellertype:"private"}).then((res22)=>{
      ...
      {
        Axios.post("http://localhost:3001/listings/FilterByListingSellertype",{ListingSellertype:"dealer"}).then((res22)=>{
          console.log(res22.data);
        setfetchListings(res22.data);
         });
      }
      ...
      {
        Axios.post("http://localhost:3001/listings/FilterByListingSellertype",{ListingSellertype:"sold"}).then((res22)=>{
          console.log(res22.data);
        setfetchListings(res22.data);
         });
      }
    ...
    if(city)
    {
      ...
      Axios.post("http://localhost:3001/listings/FilterByCityListings",{cityname:city}).then((res11)=>{
    ...
    console.log("hanji kidan");
      Axios.post("http://localhost:3001/listings/FilterByClassListings",{vehicleClass:vehicleClass}).then((res22)=>{
        console.log(res22.data);
      setfetchListings(res22.data);
       });
    }
    ...
    console.log("hanji makeName");
      Axios.post("http://localhost:3001/listings/FilterByMakeListings",{makename:makeName}).then((res33)=>{
    ...
    console.log("hanji MyState");
      Axios.post("http://localhost:3001/listings/Find_A_Car",MyState).then((res43)=>{
...
const PushArr=(e)=>
{
  if(e.length > 0)
  {
    Axios.post("http://localhost:3001/categories/getchoosedmakes",{makesarr:e}).then((res4)=>{
  ...
  else if(AllMakes.length == fetchMakes.length)
  {
     ...
     Axios.post("http://localhost:3001/categories/getchoosedmakes",{makesarr:AllMakes}).then((res4)=>{
      console.log(res4.data);
      setfetchModels(res4.data); 
    });
  }
...
const handleSellerId= (e)=>
{
  ...
  Axios.post("http://localhost:3001/users/getDealerDetails",{sellerid:e}).then((res4)=>{
      console.log(res4.data);
...
const Apply=()=>
{
 ...
 if(buyfromHome|| query1 || fetchMakes1 || fetchModels1 || minyears || maxyears || minprice || maxprice || minmileage || maxmileage || sel || sel1 ||drivetrain )
 {
  ...
  Axios.post("http://localhost:3001/listings/getFilterListings",{buyfromHome:buyfromHome,cityname:query1,bodyStyle:bodyStyle,allmodels:allModels,allmakes:AllMakes,makename:fetchMakes1,modelname:fetchModels1,minyears:minyears,maxyears:maxyears,minprice:minprice,maxprice:maxprice,minmileage:minmileage,maxmileage:maxmileage,transmission:sel,drivetrain:drivetrain,used_new:sel1}).then((res)=>{
    console.log(res.data);
    setfetchListings(res.data);
   });
 }
 ...
 const [sortFilter,setsortFilter]=useState('');
   ...
   const SearchKeyword=(e)=>
   {
      if(e.key==="Enter")
      {
        Axios.post("http://localhost:3001/listings/search_bar",{keyword:e.target.value}).then((res)=>{
          console.log(res.data);
          setfetchListings(res.data);
          });
      }
