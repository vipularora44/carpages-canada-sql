...
const setArea =(e)=>
{
   ...
   if(a>0)
   {
    Axios.post("http://localhost:3001/users/dealerbycity",{cityname:e}).then((res1)=>{
      console.log(res1.data);
   ...
   else if(a<0)
   {
    ...
    Axios.post("http://localhost:3001/users/dealerbyprovince",{province:provinceAbrivation}).then((res1)=>{
      console.log(res1.data);
      setdealerslist(res1.data);
    });
   }
