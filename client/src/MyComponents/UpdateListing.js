...
const DeleteImage=(e,f,d)=>
{
   ...
   Axios.post("http://localhost:3001/listings/deleteListingImages", {listingId:e,imageName:f,imageId:d}).then((res) =>{
        if(res.data)
        {
          VehicleImages();
          setimageOpt(false);
...
const PrimaryImage=(e,f,g)=>
{
  ...
  Axios.post("http://localhost:3001/listings/updatePrimaryListingImage", {listingId:e,imageName:f,imageId:g}).then((res) =>{
    console.log(res.data );
     ...
     for (let index = 0; index < pictures.length; index++)
      {
        ...
        Axios.post("http://localhost:3001/listings/insert_New_Images", fd1).then((res) =>{
          console.log(res.data );
          });
   }
...
const SaveData =()=>
 {
  ...
  const fd=new FormData();
    ...
    Axios.post("http://localhost:3001/listings/updateListing", fd ).then((res) =>{
        console.log(res.data );
